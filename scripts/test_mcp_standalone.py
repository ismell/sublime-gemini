...
def main():
    ...
    print(f"curl -X POST -H \"Authorization: {token}\" -H \"Content-Type: application/json\" -d \"{init_json}\" \"{base_url}\" ")
    ...
    print(f"curl -X POST -H \"Authorization: {token}\" -H \"Content-Type: application/json\" -d \"{list_json}\" \"{base_url}\" ")
    ...
    print(f"curl -X POST -H \"Authorization: {token}\" -H \"Content-Type: application/json\" -d \"{nav_json}\" \"{base_url}\" ")
